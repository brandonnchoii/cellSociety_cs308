 ...
 * arbitrary objects. It is derived from the WatorWorld Starter code. <br />
 * 
 * @author Alyce Brady
...
public interface Grid<E> {
     ...
     * @return <code>true</code> if <code>loc</code> is valid in this grid, <code>false</code>
     *         otherwise
     */
     ...
     * Precondition: (1) <code>loc</code> is valid in this grid (2) <code>obj</code> is not
     * <code>null</code>
     * @param obj the new object to be added
     * @param o the location at which to put the object
     * 
     * @return the object previously at <code>loc</code> (or <code>null</code> if the location was
     *         previously unoccupied)
     */
    E put (E obj, Occupant o);
    ...
    /**
     * Gets the locations in this grid that don't contain objects.
     * 
     * @return an array list of all unoccupied locations in this grid
     */
    ArrayList<Location> getUnoccupiedLocations ();
    
    /**
     * Gets a list of all objects currently in this grid.
     * 
     * @return an array list of all occupants in this grid
     */
    ArrayList<E> getAllOccupants ();

    /**
     * Gets the valid locations adjacent to a given location in all eight compass directions (north,
     * northeast, east, southeast, south, southwest, west, and northwest). <br />
     * Precondition: <code>loc</code> is valid in this grid
     * 
     * @param loc a location in this grid
     * @return an array list of the valid locations adjacent to <code>loc</code> in this grid
     */
    ArrayList<Location> getValidAdjacentLocations (Location loc);

    /**
     * Gets the valid empty locations adjacent to a given location in all eight compass directions
     * (north, northeast, east, southeast, south, southwest, west, and northwest). <br />
     * Precondition: <code>loc</code> is valid in this grid
     * 
     * @param loc a location in this grid
    ...
    /**
     * Gets the valid occupied locations adjacent to a given location in all eight compass
     * directions (north, northeast, east, southeast, south, southwest, west, and northwest). <br />
     * Precondition: <code>loc</code> is valid in this grid
     * 
     * @param loc a location in this grid
     * @return an array list of the valid occupied locations adjacent to <code>loc</code> in this
     *         grid
     */
    ...
    void setCellShape(String s);
    
    void addLocation(Location l);
    
    ArrayList<Location> getLocations();
    
    void setLocations(ArrayList<Location> l);
