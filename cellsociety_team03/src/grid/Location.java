...
public class Location implements Comparable<Location> {
    ...
    public Location getAdjacentLocation (int direction) {
        ...
        return new Location(getRow() + dx, getCol() + dy);
    }
    ...
    /**
<<<<<<< HEAD
     * @return a string with represents row and column coordinates of this location
=======
     * Creates a string that describes this location.
     * 
     * @return a string with the row and column of this location, in the format
     *         (row, col)
>>>>>>> db99774c4e75418c42786d8c894eb110363a1bfb
     */
